...
import ModelSceneTask from '@ultron/modules/httpSceneDetail/MHttpSceneDetail';
...
@observer
export default class ModalFileContent extends AView<ModelSceneTask> {
    constructor(p, c) {
        super(p, c);
    }
    @Bind()
    ...
    private setNumberInput(e): void {
        this.model.modelConfigScene.setNumberInput(e.target.value);
    ...
    public render(): React.ReactNode {
        return (
            <div>
                <ObsNumberInput
                    model={ this.model.modelConfigScene.moreConfig }
                    onKeyUp={ this.search }
                ...
                <div className={ style.box }>
                    {
                        this.model.modelConfigScene.moreConfig.fileContentArr.map((item, index) => {
                            return (
