 ...
 * http多接口查看配置模型
 */
export default class ModelHttpMultiTask extends AModuleModel {
    public modelConfigHttpMulti: ModelTestConfigMH;
    ...
    public get vUrlTaskDetail() {
        const p = {
            planId: this.planId,
            taskId: this.taskId,
            type: this.modelConfigHttpMulti.type,
            planName: this.modelConfigHttpMulti.planName,
            businessCode: this.modelConfigHttpMulti.moreConfig.businessNum
        };
    ...
    constructor(query: IPlainObject = {}) {
        ...
        this.modelConfigHttpMulti = new ModelTestConfigMH(query.planId, query.planName);
    }
