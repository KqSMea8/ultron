 ...
 * http单接口查看配置模型
 */
export default class ModelThriftTask extends AModuleModel {
    public modelConfigThrift: ModelTestConfigThrift;
    ...
    public get vUrlTaskDetail() {
        const p = {
            planId: this.planId,
            taskId: this.taskId,
            type: this.modelConfigThrift.type,
            planName: this.modelConfigThrift.planName
        };
    ...
    constructor(query: IPlainObject = {}) {
        ...
        this.modelConfigThrift = new ModelTestConfigThrift(query.planId, query.planName);
    }
